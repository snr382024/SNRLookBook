    ...
    <div className="template-four-container">
      <div className="image-wrapper">
        ...
        <div className="column-type1">
          <div className="rectangle" ref={refs[1]} onClick={() => handleFlip(1)}>
        ...
        <div className="column-type2">
          ...
          <div className="rectangle" ref={refs[2]} onClick={() => handleFlip(2)}>
        ...
        <div className="column-type1">
          <div className="rectangle" ref={refs[3]} onClick={() => handleFlip(3)}>
    ...
    <div className="template-four-container">
      <div className="image-wrapper">
        <div className="column-type1">
          ...
          <div className="rectangle" ref={refs[0]} onClick={() => handleFlip(0)}>
            <div className={`flip-container ${isFlipped[0] ? "flipped" : ""}`}>
              <div className="flipper">
                <div className="front">
                  <img src={images[4].src} alt={images[4].alt} />
